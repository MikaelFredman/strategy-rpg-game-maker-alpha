...
1. Open the public [`0.2.0-beta.9` package](downloads/Strategy-RPG-Game-Maker-0.2.0-beta.9.zip).
2. Download `Strategy-RPG-Game-Maker-0.2.0-beta.9.zip` using GitHub's download button.
...
13. In an AI-only world simulation, inspect Latest world event for decisions to strike before reinforcements arrive, consolidate against a reinforced enemy or form a multi-group army.
